...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a href="#" id="toMainPage" data-toggle='tooltip' title='Главная страница'><i class="fa fa-graduation-cap fa-2x" aria-hidden="true"></i></a>
 ...
 <div class="album py-5 bg-light">
    ...
    <div class="container">
    <button class="btn btn-primary" id="updateUsers">Обновить</button>
    </div>
  </div>
